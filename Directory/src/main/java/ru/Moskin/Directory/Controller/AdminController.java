...
public class AdminController {
    ...
    public AdminController(@Autowired WorkerService workerService, @Autowired BranchService branchService, @Autowired PositionService positionService, @Autowired RoleService roleService) {
    ...
    public  String branchAddPost(Model model, @RequestParam String name, @RequestParam String city, @RequestParam String address) {
    ...
    public  String branchEditPost(Model model, @RequestParam String name, @RequestParam String city, @RequestParam String address, @PathVariable(value = "id") Long id) {
